...
public class GetSchemeListApi extends BaseApi {


    public GetSchemeListApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.getSchemeList();
    }
}
