...
public class GetDeliverOrderListApi extends BaseApi {


    private Map<String,Object> map ;

    public GetDeliverOrderListApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.getDeliverOrderList(map);
    }
}
