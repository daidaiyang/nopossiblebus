...
public class GetIntegralSumApi extends BaseApi {



    public GetIntegralSumApi(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        ...
        return httpGetService.getIntegralSum();
    }
}
