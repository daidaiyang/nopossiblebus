package com.nopossiblebus.customview;
...
public class WaveView extends View {
    ...
    private boolean mIsRunning;//是否运行
    private long mLastCreateTime;//最晚的圆的创建时间

    private Bitmap bitmap;

    private List<Circle> mCircleList = new ArrayList<Circle>();//创建的圆集合
    ...
    private Interpolator mInterpolator = new LinearInterpolator();//加速器
    ...
    private class Circle {
        ...
        int getAlpha() {
            ...
            return (int) (355 - mInterpolator.getInterpolation(percent) * 255);
        }
